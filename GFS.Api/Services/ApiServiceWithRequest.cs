...
namespace GFS.Api.Services
{
    ...
    {
        private readonly ILogger<ApiServiceWithRequest<TRequestPayload>> _logger;

        protected ApiServiceWithRequest(ILogger<ApiServiceWithRequest<TRequestPayload>> logger)
        {
            _logger = logger;
        }
