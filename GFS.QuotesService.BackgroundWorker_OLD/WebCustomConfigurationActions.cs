...
public class WebCustomConfigurationActions : WebCustomConfigurationActionsAbstract
{
    ...
    {
        ServiceCollection.AddAutoMapper(expr => expr.AddProfile(new QuotesMappingProfile()), typeof(WebCustomConfigurationActions));
    }
    ...
    {
        return lc
            .Enrich.WithProperty("Application", "GFS.QuotesService.BackgroundWorker_OLD")
