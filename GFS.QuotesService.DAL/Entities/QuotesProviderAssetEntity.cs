...
public class TinkoffAssetEntity : QuotesProviderAssetEntity
{
    ...
    public TinkoffGetQuotesRequestModel TinkoffGetQuotesRequest { get; set; }
}

public class FinamAssetEntity : QuotesProviderAssetEntity
{
    [Column(TypeName = "jsonb")]
    public FinamGetQuotesRequestModel FinamGetQuotesRequest { get; set; }
}

public class BcsExpressAssetEntity : QuotesProviderAssetEntity
{
    [Column(TypeName = "jsonb")]
    public BcsExpressGetQuotesRequestModel BcsExpressGetQuotesRequest { get; set; }
}

public class InvestingComAssetEntity : QuotesProviderAssetEntity
{
    [Column(TypeName = "jsonb")]
    public InvestingComGetQuotesRequestModel InvestingComGetQuotesRequest { get; set; }
}
